...
module.exports = class navPGHelper {
	...
	new navPaymentsDAO().updatePaymentDetails(response.orderId,response.code + "::" +response.status +"::"+response.message, navPaymentsDAO.getStatus().FAILED, new Date().getTime())
	    .done(function(){
